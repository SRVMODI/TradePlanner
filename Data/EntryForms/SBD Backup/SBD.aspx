...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (RoleID == "2") {
                ...
                $("#divTypeSearchFilterBlock").css("width", "62%");
            }
        ...
        function fnShowHierFilter(ctrl) {
            ...
            if (flgVisibleHierFilter == "0") {
                ...
                if (RoleID == "1" || RoleID == "2" || RoleID == "4") {
                    ...
                    $("#divTypeSearchFilterBlock").css("width", "17%");
                    if (RoleID == "2") {
                    ...
                    if (RoleID == "2") {
                        $("#divTypeSearchFilterBlock").css("width", "35%");
                    }
                }
            }
            else {
        ...
        function fnGetReport_pass(res, flg) {
            if (res.split("|^|")[0] == "0") {
                ...
                for (h = 0; h < trArr.length; h++) {
                    leftfixed += "<tr SBD='" + trArr.eq(h).attr("SBD") + "' SBDName='" + trArr.eq(h).attr("SBDName") + "'>";
                    for (var i = 0; i < 3; i++) {
                        if (i == 0) {
    ...
    <script type="text/javascript">
        ...
        function fnSave(ctrl, flgDuplicate) {
            ...
            var strBaseProduct = rttr.find("td[iden='SBD']").eq(6).find("img[iden='BaseSBF']").eq(0).attr("SBFHiier").split("||||")[0];
            var strBrand = rttr.find("td[iden='SBD']").eq(6).find("img[iden='BaseSBF']").eq(0).attr("SBFHiier").split("||||")[1];
            ...
            if (strChannel == "") {
                ...
                $("#dvloader").show();
                PageMethods.fnSave(SBDID, SBDName, FromDate, EndDate, strChannel, strLocation, strBaseProduct, UserID, LoginID, RoleID, QtrNo, QtrYear, Buckets, BucketValues, SBF, flgDuplicate, Frequency, strBrand, fnSave_pass, fnfailed, ctrl);
            }
        }
    ...
    <script type="text/javascript">
        ...
        function fnShowSBFHierPopup(ctrl) {
            $("#divProxySBFTbl").attr("brand", "");
            
            if ($(ctrl).attr("sbfhiier").trim() == "") {
                var LoginID = $("#ConatntMatter_hdnLoginID").val();
                var RoleID = $("#ConatntMatter_hdnRoleID").val();
                var UserID = $("#ConatntMatter_hdnUserID").val();
                var Qtr = $("#ddlQuarter").val().split("|")[2];
                ...
                $("#divProxySBFTbl").attr("brand", $(ctrl).attr("sbfhiier").split("||||")[1]);
                fnSBFHierPopup(ctrl);                
            }
        }
                ...
                if (res.split("|^|")[1] != "") {
                    ...
                    $("#divConfirm").dialog({
                        ...
                        buttons: [{
                            ...
                            class: 'btn-primary',
                            click: function () {
                                $("#divProxySBFTbl").attr("brand", $("#divConfirm").find("input[type='radio']:checked").eq(0).closest("tr").attr("brand"));
    ...
    <style type="text/css">
        ...
        #dvSBDListforImportBody table td:nth-child(1),
...
<asp:Content ID="Content3" ContentPlaceHolderID="ConatntMatter" runat="Server">
    ...
    <div class="row no-gutters" style="margin-top: -10px;">
        <div class="fsw col-12" id="Filter">
            <div class="fsw_inner">
                <div class="fsw_inputBox" style="width: 12%; padding: 6px;">
                ...
                <div class="fsw_inputBox" id="divHierFilterBlock" style="width: 12%; padding: 6px;">
                    <div class="row">
                        ...
                        <div class="col-5" id="HierFilterBlock" style="display: none; padding-right: 0;">
                            ...
                            <div class="d-block">
                                <a id="txtProductHierSearch" class="btn btn-primary btn-sm" href="#" buckettype="1" prodlvl="40" prodhier="" onclick="fnShowProdHierPopup(this, 0);" title="Product Filter" style="font-size: 0.8rem; padding: 0.25rem 0.2rem;">Product</a>
                                <a id="btnClusterFilter" class="btn btn-primary btn-sm" href="#" onclick="fnShowClusterPopup(this);" title="Cluster Filter" selectedstr="" style="font-size: 0.8rem; padding: 0.25rem 0.2rem;">Cluster</a>
                ...
                <div class="fsw_inputBox" id="divAddNewFilterBlock" style="width: 13%; padding: 6px 2px 0 6px;">
                    ...
                    <div class="d-block">
                        <a href="##" class="btn btn-primary btn-sm" id="btnAddNewINIT" onclick="fnAddNew();" title="Add New SBD"><i class="fa fa-plus-square"></i>&nbsp; Add</a>
                        <a href="##" class="btn btn-primary btn-sm" id="btnCopyINIT" onclick="fnImportPrevQtrSBDPopup();" title="Import SBD from previous month to current month" style="margin-left: 1%;"><i class="fa fa-clone"></i>&nbsp; Import</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="divFooter" style="width: 100%; background: #ddd; border: 1px solid #ccc; position: fixed; bottom: 0; padding: 6px 0; margin-left: -23px;">
        <div id="divLegends" style="width: 81%; margin-left: 5px; padding: 5px 8px; background: #fff; border: 1px solid #bbb; border-radius: 4px; display: inline-block; float: left;"></div>
        ...
        <div class="row no-gutters">
            <div class="col-12 fsw" style="margin-bottom: 4px;">
                <div class="fsw_inputBox" style="width: 100%; display: inline-block; min-height: 46px;">
                    ...
                    <select id="ddlQuarterPopup" class="form-control form-control-sm" onchange="fnImportPrevQtrSBD();" style="width: 40%; margin-left: 20px; display: inline;"></select>
                </div>
            </div>
        </div>
        <div id="dvSBDListforImportBody" style="max-height: 424px; overflow-y: auto;"></div>
    </div>
