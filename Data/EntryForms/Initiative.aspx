    ...
    <script type="text/javascript">
        function fnAddNew() {
            if ($("#ConatntMatter_hdnIsNewAdditionAllowed").val() == "0") {
                ...
                $("#tblReport").find("tbody").eq(0).find("tr[iden='Init']").eq(0).find("td[iden='Init']").eq(15).find("select").eq(0).val($("#ConatntMatter_hdnINITType").val().split("^")[1]);
        ...
        function fnEditCopy(ctrl, cntr) {
            ...
            tr.find("td[iden='Init']").eq(15).html("<select onchange='fnCOHbasedOnInitType(this);'>" + $("#ConatntMatter_hdnINITType").val().split("^")[0] + "</select>");
