<%@ Page Title="" Language="C#" MasterPageFile="~/Data/MasterPages/site.master" AutoEventWireup="true" CodeFile="Cluster.aspx.cs" Inherits="_BucketMstr" %>
        ...
        <div class="fsw_inner">
            ...
            <div class="fsw_inputBox" id="divAddNewCopyBtnBlock" style="width: 20%;">
                ...
                <div class="d-block">
                    ...
                    <a href="#" class="btn btn-primary btn-sm" id="btnImport" onclick="fnImportPrevQtrCluster();" title="Import Cluster from Previous Quarter to Current Quarter" style="margin-left: 5%;"><i class="fa fa-clone"></i>&nbsp; Import</a>
                </div>
            </div>
        </div>
    </div>
